...
> * We will NEVER monetize or sell Your Personal Data 
> * We ALWAYS seek to minimize data collection. The collection or use of your personal data is kept to a minimum on our Websites or Apps. 
> * We ALWAYS maximize security. It is a priority. This also applies when we use third party products or services. 
...
*   **Organization** (referred to as either "the Organization", "We", "Us" or "Our" in this Agreement) refers to the NGO "Berty Technologies" located at 96 Boulevard Bessières, 75017 Paris, France.
    For the purpose of the GDPR, the Organization is the Data Controller.
