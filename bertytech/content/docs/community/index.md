...
_Not your language available yet? Help the community to translate this page._ 


## 🏠🗺️ Community

*Welcome to the Berty family. We should warn you: it's a pretty big family and our home is all over the world. Wherever you are, we welcome you in.*
...
*Please never underestimate your contribution. Little + Little = Big. We do believe in the _butterfly effect_. Help us to fight censorship and mass surveillance because everyone's privacy matters.*
...
The hardest part is always getting started and a lot of people are wondering where to start. The answer is very simple: there are no little things, just do it! 

Here's **5 quick and easy steps** before digging in that will help us a lot:
...
* Read our [blogposts](https://berty.tech/blog) and [latest news](https://berty.tech/newsletter).
...
> **Note:** Btw, you could be an ambassador! Simply submit your application on Discord. We're constantly looking for the next amazing ambassador!  
...
> **Note:** If you have other ideas to improve this section, or want to set up an event, go to [Discord](https://crpt.fyi/berty-discord) and ping @pierre. He is here to help (and doesn't bite 😏).  
...
There are plenty of ways to get involved in and act for our community. It has been divided into two distinct parts: everything that is related to the code and everything that is not. 
...
To facilitate and centralize contributions, we rely only on Github for code contribution. We use `issues` as a discussion forum and contributions can be done in a pull request. 

If you're looking for something to get your feet wet working on Berty, take a look at the GitHub numbers tagged [`good first issue`](https://github.com/berty/berty/labels/good%20first%20issue) or [`help wanted`](https://github.com/berty/berty/labels/help%20wanted).

Here is a bunch of contribution ideas:
* Answer questions from the community on issues. 
...
> Didn't find any inspiration above? Get stuck? Don't know how to start? Please send an email to let us know and we will be pleased to help you!
...
* 🖌️ We bootstrap a street art project on whistleblowers called '[Berty Priv-art](https://berty.tech/art)'. Help us to make it concrete!  
...
As you can guess, we don't know every language. However, we want Berty to be accessible to as many people as possible. That's why we need as much material as possible translated into as many languages as possible. 

This can be the documentation, the app, the support, a blogpost, even this page, or another section on the site. 

### 🐞 Bug and Report

We use GitHub issues for tracking requests and bugs. Please post questions directly there using the 'bug' tag.
...
> To help us to improve our support page? Reach @Camille.

### ✍️ Website & Blog  
 
Having a good website helps to make the Berty project as common as possible. So if you have any ideas for improvement (SEO for example), let us know. We'll be happy to adjust!
...
You will find awesome outfits 👕 , enviable stickers 🖼️, classy hats 🧢, and lots more merch that you’ll want to get your mitts on.

> All our designs will be made by the community 🧡
